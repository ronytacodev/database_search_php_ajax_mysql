...
$host 		 = "localhost:33065";    	// Nombre del servidor donde esta alojada nuestra base de datos
$basededatos = "search_ajax";   // Nombre de la base de datos (¡Las mayusculas IMPORTAN!)
...
if ($conexion->connect_errno) {
	echo
	    ...
	    <br> <br>
	    <center>
	    	<b><p class="text-uppercase">Si tiene alguna duda siéntase en libertad de contactarme al correo <a target="_blank" href="http://www.ronytaco.com/main/contacto">contacto@ronytaco.com</a></p></b>
	    </center>
	    </div>';
	exit();
}
